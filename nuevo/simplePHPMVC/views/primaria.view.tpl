  ...
  <div id="main" class="container">
    ...
    <div id="content">
      ...
      <article class="box post">
        ...
        <p>
          ...
          <ol>
            ...
            <li>Practiquen hábitos de estudio, alimenticios y de higiene general.</li>
            <li>Expresen sus ideas de manera clara, coherente y desarrollen una autoestima adecuada</li>
            <li>Distingan los símbolos y señales significativas básicas, de tránsito y naturales de su
              entorno social.</li>
      ...
      <p>
          ...
          competencias:
          <ul>
            <li>Conozcan los valores tradicionales, más significativos, de la cultura regional y nacional.</li>
            <li>Comprendan el valor que tienen los miembros de su núcleo familiar en su crecimiento y
              desarrollo personal, la función de cada integrante y que cumplan con el rol que le
              corresponde dentro del mismo</li>
            <li>Practiquen hábitos de estudio, higiene personal y de sana alimentación</li>
            <li>Manifiesten actitud de respeto ante los símbolos patrios. Entonen correctamente el
              Himno Nacional</li>
            <li>Utilicen las operaciones de suma, resta y multiplicación para elaborar y resolver
                problemas sencillos de su entorno cotidiano</li>
      ...
      <p>
          ...
          competencias:
          <ul>
            <li>Desarrollen la creatividad al realizar sus actividades o al abordar la resolución de
              problemas.</li>
            <li>Practiquen los acuerdos de convivencia escolar, normas de conversación como oyente y
              como hablante, normas de cortesía, hábitos de estudio, de sana alimentación e higiene
              personal.</li>
            <li>Establezcan relaciones interpersonales abiertas, espontáneas y positivas.</li>
            <li>Trabajen efectivamente en equipo y cumplan responsablemente con sus actividades.</li>
            <li>Manifiesten actitudes de solidaridad, responsabilidad, honradez, tolerancia para la
              práctica y promoción de la paz</li>
            <li>Manejen asertivamente las relaciones temporales, espaciales, medidas y peso en
      ...
      <p>
          ...
          competencias:
          <ul>
            <li>Manejen adecuadamente los valores: Respeto, responsabilidad, tolerancia, convivencia,
              colaboración, honestidad y demás actitudes que favorezcan el desarrollo de su
              personalidad.</li>
            <li>Manifiesten confianza y seguridad al realizar sus actividades y comunicar sus ideas.</li>
            <li>Utilizan el lenguaje adecuadamente como medio de comunicación, recreación y crecimiento
              personal.</li>
            <li>Manejen adecuadamente sus emociones: Ira, alegría, tristeza, miedo. </li>
            <li>Consoliden su proceso de comprensión lectora y que reconozcan la literatura como fuente
